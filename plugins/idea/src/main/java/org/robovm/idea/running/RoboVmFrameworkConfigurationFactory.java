...
public class RoboVmFrameworkConfigurationFactory extends ConfigurationFactory {
    protected RoboVmFrameworkConfigurationFactory(ConfigurationType type) {
        super(type);
    }
    ...
    public RunConfiguration createTemplateConfiguration(@NotNull Project project) {
        return new RoboVmIOSFrameworkRunConfiguration(getType(), "RoboVM Run Configuration", new RunConfigurationModule(project), this);
    }
