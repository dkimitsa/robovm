 ...
 * {@link AppLauncher}.
 */
public class AppLauncherProcess extends Launchers {

    /**
     * Creates customizable launcher
     */
    ...
    /// thread around AppLauncher
    private static class LauncherThread extends Launchers.LauncherThread<IOSDeviceLaunchParameters> {
        private final AppLauncher launcher;

        private LauncherThread(Builder builder, File appDir) throws IOException {
            super(builder);
    ...
    public static class Builder extends Launchers.Builder<IOSDeviceLaunchParameters> {
        ...
        @Override
        protected Launchers.Builder<IOSDeviceLaunchParameters> duplicate() {
            return new Builder(log, listener, launchParameters, appDir);
        }
        ...
        protected LauncherThread createAndSetupThread(boolean async) throws IOException {
            ...
            LauncherThread launcher = new LauncherThread(this, appDir);
            if (async) {
